...
{{--                        <form id="demo-form2" method="post" action="{{route('admin.users.store')}}" data-parsley-validate class="form-horizontal form-label-left">--}}
                        {{Form::open(['route' => 'admin.products.courses.store', 'files'=>'true', 'method' => 'post', 'class'=>"form-horizontal form-label-left", 'data-parsley-validate'=>''])}}
                            @csrf
                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                ...
                                <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab"
                                                                    data-toggle="tab" aria-expanded="false">جزئیات دوره</a>
                                </li>
...
{{--                                </li>--}}
                            ...
                            <div id="myTabContent" class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="tab_content2"
                                    ...
                                    <!-- start user projects -->
                                    @include('admin.products.courses.form')
                                    <!-- end user projects -->
                                    <button type="submit" class="btn btn-success" >ثبت اطلاعات</button>
                                </div>
