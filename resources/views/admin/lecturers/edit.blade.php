            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        ...
                        {{Form::model($info,['route' => ['admin.lecturers.update', $info->id], 'files'=>'true', 'method' => 'post', 'class'=>"form-horizontal form-label-left", 'data-parsley-validate'=>''])}}
                        @csrf
                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                <li role="presentation" class="active"><a href="#tab_content2" id="home-tab"
                                                                          role="tab" data-toggle="tab"
                                                                          aria-expanded="true">اطلاعات سخنران</a>
                                </li>
                            </ul>
