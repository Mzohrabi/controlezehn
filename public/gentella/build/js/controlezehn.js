    ...
    return {
        ...
        deleterecord: function () {
            ...
            function recordDelete(recordId, deleteUrl, dependency, dependencyMessage) {
                if (dependency) {
                    Swal.fire("Warning!", dependencyMessage, "warning");
                }
                else {
                    Swal.fire({
                        title: "آیا مطمئنید؟",
                        text: "حذف این رکورد منجر به حذف شدن رکوردهای وابسته به آن می شود",
                        type: "warning",
                        showCancelButton: true,
                        showLoaderOnConfirm: true,
                        closeOnConfirm: false,
                        ...
                        $.ajax({
                            ...
                            .error(function (data) {
                                Swal.fire("خطا", "امکان ارتباط با سرور وجود ندارد", "error");
                            });
                    }});
                };
