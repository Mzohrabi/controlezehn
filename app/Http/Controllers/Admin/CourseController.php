...
class CourseController extends Controller
{
    public function index(LectureDataTable $dataTable) {
        $courses = Course::all();
        return $dataTable->render('admin.products.courses.index', compact('courses'));
    }

    public function create() {
        $lecturers = Course::all();
        $lecturer_array = FormUtilities::createSelectArray($lecturers, 'id', 'name');
        return view('admin.products.courses.create', compact('lecturer_array'));
    }
    ...
    public function edit($id) {
        ...
        $lecturers = Course::all();
        $lecturer_array = FormUtilities::createSelectArray($lecturers, 'id', 'name');
        return view('admin.products.courses.edit', compact('info','lecturer_array'));
    }
    ...
    public function store(Request $request, Lecture $lecture, Product $product) {
        ...
        try{
            ...
            return redirect(route('admin.products.courses'));
        }catch (\Exception $e){
            die($e->getMessage());
            DB::rollBack();
